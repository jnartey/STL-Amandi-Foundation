...
class UsersController extends AppController {
	...
	public function beforeFilter() {
		...
		$about_menus = $this->PageContent->find('all', array('conditions'=>array('PageContent.category'=>1)));
		$domains_menu = $this->PageContent->find('all', array('conditions'=>array('PageContent.category'=>8)));
		$project_menu = $this->PageContent->find('all', array('conditions'=>array('PageContent.category'=>10)));
		$csr_menu = $this->PageContent->find('all', array('conditions'=>array('PageContent.category'=>11)));
		$contacts_menu = $this->PageContent->find('all', array('conditions'=>array('PageContent.category'=>12)));
		
		if($this->RequestHandler->isMobile()) {
			$mobile_detect = true;
		}
		
		$this->set(compact('mobile_detect', 'about_menus', 'project_menu', 'sub_page', 'domains_menu', 'csr_menu', 'contacts_menu'));
	}
	...
	public function client_login() {
		$title_for_layout = "SuperTech Client Login";
		$this->set(compact('title_for_layout'));
