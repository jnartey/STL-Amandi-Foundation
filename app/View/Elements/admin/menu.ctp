	...
	<nav class="top-bar">
	  ...
	  <section class="top-bar-section">
	    ...
	    <ul class="left">
			...
			<li>
	          <?php echo $this->Html->link(__(("Project Gallery"), true), array('controller'=> 'galleries', 'action'=>'index', 'admin' => true), array('escape' => false, 'class'=>'admin-panel fancybox.iframe')); ?>
			</li>
			<li>
