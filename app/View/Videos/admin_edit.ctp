	...
	<div class="large-10 columns content">
		...
		<div class="large-7 columns">
			...
			<?php
				...
				if($parent['Video']['video_category'] == 1 && $parent['Video']['video_content'] == 0){
				...
				}elseif($parent['Video']['video_content'] == 0){
					echo $this->Form->input('name', array('label'=>false, 'placeholder'=>'Name'));
					echo $this->Form->hidden('video_category', array('value' => 1));
				...
				if($parent['Video']['video_content'] == 1){
					...
					echo $this->Form->hidden('video_content', array('value'=>1));
					if($item_parent[0]['Video']['category']){
						echo $this->Form->hidden('parent', array('value'=>$parent['Video']['category']));
						echo $this->Form->hidden('category', array('value'=>$parent['Video']['id']));
					}
				}
