		...
		<?php 
			...
			echo '<div class="large-12 columns">';
				...
				if($page['PageContent']['page_type'] == 0){
					...
					echo $this->Form->hidden('page_type', array('value' => $page['PageContent']['page_type']));
				}
				...
				if($page['PageContent']['page_type'] == 6){
					echo $this->Form->input('title', array('placeholder'=>'Title'));
...
$(function() {
	...
	var optionSelected_ex = $('#PageContentPageLayout').val();
	if(optionSelected_ex == '2' || optionSelected_ex == '3'){
		$('#icon').show();
	}
	
	if(optionSelected_ex == '2'){
		$('#page-image').show();
	}
